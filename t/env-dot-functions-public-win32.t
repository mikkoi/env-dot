...
subtest_streamed 'Private Subroutine interpret_dotenv_filepath_var()' => sub {
...

    {
        ...
        my @paths = Env::Dot::Functions::interpret_dotenv_filepath_var( $var );
        T2->is( \@paths, [ q{C:\home\user\.env}, ], 'Filepaths right' );
    }
...

    {
        my $var = q{;C:\home\user\.env};
        my @paths = Env::Dot::Functions::interpret_dotenv_filepath_var( $var );
        T2->is( \@paths, [ q{}, q{C:\home\user\.env}, ], 'Filepaths right' );
    }
...

    {
        ...
        my @paths = Env::Dot::Functions::interpret_dotenv_filepath_var( $var );
        T2->is( \@paths, [ q{C:\home\user\.env}, q{subdir\.env}, ], 'Filepaths right' );
    }
...

    {
        my $var = q{C:\Users\me};
        my @paths = Env::Dot::Functions::interpret_dotenv_filepath_var( $var );
        T2->is( \@paths, [ q{C:\Users\me}, ], 'Filepaths correct, Win paths' );
    }

    {
        ...
        T2->is( \@paths, [
                q{C:\home\me\.env},
                q{home\you\.env:home\you\subdir\.env},
            ], 'Filepaths correct, Faulty separators' );
    }

    {
        ...
        T2->is( \@paths, [
                q{C:\Users\.env},
                q{C:\home\you\.env:C:\home\you\subdir\.env},
            ], 'Filepaths correct, Faulty separators' );
    }

    {
        ...
        my @paths = Env::Dot::Functions::interpret_dotenv_filepath_var( $var );
        T2->is( \@paths, [ q{C:\home\\}, q{subdir\.env}, q{\\}, ], 'Filepaths right' );
    }
